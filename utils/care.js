...
export const HUMIDITY_SEASONAL = [
    { months: [12, 1, 2], label: '冬季', tip: '注意加溫，天冷時水盆蒸散較慢，仍需確認主環境不會過乾並定期換水。' },
    { months: [3, 4, 5], label: '春季', tip: '日夜溫差大，留意夜間加溫足夠，同時觀察水盆周邊是否太潮。' },
    { months: [6, 7, 8], label: '夏季', tip: '留意通風與水盆清潔，避免主環境長期悶濕。' },
    { months: [9, 10, 11], label: '秋季', tip: '入秋日夜溫差拉大，加溫設備提前測試，並觀察飲水量是否變化。' }
]
...
export const SPECIES_COMPARE = [
    ...
    { feature: '溫度', leopard: '冷區 26–28°C，過渡區 28–30°C，熱區 30–32°C', fattail: '冷區 26–28°C，過渡區 29–31°C，熱區 31–33°C' },
    { feature: '耐熱性', leopard: '耐熱沒問題，但通常以偏乾環境搭配熱區為主', fattail: '可接受與豹紋同級甚至略高的熱端；真正關鍵不是降溫，而是高溫下仍保持通風與局部濕區' },
    { feature: '濕度', leopard: '主環境 40–70%，維持濕度梯度與水盆', fattail: '主環境 40–70%，維持濕度梯度與水盆' },
    { feature: '個性', leopard: '較活潑，通常比較不好上手', fattail: '通常更溫和、較易上手' },
    { feature: '餵食', leopard: '蟋蟀 / 杜比亞 / 麵包蟲', fattail: '蟋蟀 / 杜比亞 / 麵包蟲' },
    { feature: '常見問題', leopard: '卡皮、底材誤食、腸胃問題', fattail: '卡皮、底材誤食、腸胃問題稍微更常見' }
]
