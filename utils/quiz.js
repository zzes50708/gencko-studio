...
export const QUIZ_TRACKS = {
    viewer:    { label: '觀賞型', icon: '🔍', desc: '純粹喜歡守宮的外型與靜謐感，享受日常觀察。', links: [
        { text: '品系圖鑑', href: '/genes' },
        { text: '飼養教學文章', href: '/articles' }
    ]},
    breeder:   { label: '繁殖型', icon: '🧬', desc: '想學習基因組合、嘗試繁殖出自己的 morph。', links: [
        { text: '基因計算機', href: '/calc' },
        { text: '品系圖鑑', href: '/genes' }
    ]},
    collector: { label: '收藏型', icon: '📚', desc: '想長期收藏多隻、不同品系的個體。', links: [
        { text: '品系圖鑑', href: '/genes' },
        { text: '飼養教學文章', href: '/articles' }
    ]},
    newbie:    { label: '嘗鮮型', icon: '⚠️', desc: '可能是跟風或一時興起，建議先確實補課再決定。', links: [
    ...
    questions: [
        // ============ ⏱ Time 時間承諾 ============
        {
            ...
            options: [
                ...
                { id: 't1c', label: '只能 2–3 天弄一次', score: 5, risk: 'warn',
                    note: '守宮雖耐糙養，但每日簡短觀察是發現拒食、便秘、外傷的關鍵時機。隔 2–3 天才檢查，小問題容易拖成大問題。' },
                { id: 't1d', label: '希望牠完全不用照顧', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 't2c', label: '先養再說，未來再看', score: 4, risk: 'warn',
                    note: '守宮壽命 10–15 年，這期間您可能換工作、搬家、結婚、生子。沒想清楚就開始，最常見的結局是棄養或轉讓。' },
                { id: 't2d', label: '只是跟風想嘗鮮', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 't3c', label: '超過 3 天但無人代看', score: 4, risk: 'warn',
                    note: '長時間離家無人照看，水盆乾涸、糞便堆積、突發狀況都無人處理。請確認您的生活型態能配合或有穩定後援。' },
                { id: 't3d', label: '從未考慮過這個情境', score: 0, risk: 'critical',
        ...
        // ============ 🧠 Mind 心理接受 ============
        {
            ...
            options: [
                ...
                { id: 'm1d', label: '極度恐懼昆蟲，完全無法觸碰', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'm2c', label: '希望牠會主動親近我、回應我', score: 4, risk: 'warn',
                    note: '守宮不會主動親近主人，也不會用眼神回應您。如果您期待「被陪伴感」，飼養後容易失落，建議重新評估是否適合。' },
                { id: 'm2d', label: '不能撒嬌的我就不想養', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'm3c', label: '會碎念但不會強烈反對', score: 6, risk: 'warn',
                    note: '家人雖未強烈反對，但長期碎念會影響飼養品質與心情。建議事前充分溝通，讓家人理解守宮的飼養細節。' },
                { id: 'm3d', label: '有人極度反感蛇/蜥蜴/蟲', score: 0, risk: 'critical',
        ...
        // ============ 🌡 Env 環境設備 ============
        {
            ...
            options: [
                ...
                { id: 'e1c', label: '只買加溫墊，無控溫器邊養邊看', score: 3, risk: 'critical',
                    note: '無控溫器的加溫墊可能持續加熱導致低溫燙傷（守宮致死常見原因），也可能溫度不足。控溫器是基本配備，不是進階配備。' },
                { id: 'e1d', label: '台灣這麼熱，不需要溫控', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'e2c', label: '先放桌上再說', score: 5, risk: 'warn',
                    note: '擺放位置會影響溫度穩定（陽光直射、冷氣直吹）、噪音壓力與日常觀察便利。建議飼養前就確定專屬位置。' },
                { id: 'e2d', label: '還沒想過要放哪', score: 2, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'e3c', label: '聽說過但不確定怎麼做', score: 4, risk: 'warn',
                    note: '台灣寒流可能跌破守宮可承受溫度，梅雨季濕度過高易引發皮膚病。事前學會季節調節，可避免突發狀況措手不及。' },
                { id: 'e3d', label: '完全沒概念', score: 0, risk: 'critical',
        ...
        // ============ 📚 Knowledge 知識儲備 ============
        {
            ...
            options: [
                ...
                { id: 'k1c', label: '聽過但細節不清楚', score: 4, risk: 'warn',
                    note: 'MBD、拒食、脫皮不順是守宮三大常見問題，多源自環境或營養失衡。飼養前至少了解症狀與初步處置，以免錯失治療時機。' },
                { id: 'k1d', label: '完全沒聽過', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'k2c', label: '大概看牠有沒有動', score: 3, risk: 'critical',
                    note: '僅靠是否會動判斷健康，等於放棄 90% 的預警機會。拒食、脫水、感染初期，守宮仍會活動。請學會看糞便、體態、皮膚與眼神。' },
                { id: 'k2d', label: '不知道要觀察什麼', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'k3c', label: '哪家便宜就買哪家', score: 4, risk: 'warn',
                    note: '便宜的守宮常來自不明來源或淘汰個體，帶病（隱孢子、寄生蟲）機率較高，後續醫療成本反而更高。' },
                { id: 'k3d', label: '路邊攤、夜市或來路不明的賣家', score: 0, risk: 'critical',
        ...
        // ============ 💰 Budget 預算資源 ============
        {
            ...
            options: [
                ...
                { id: 'b1c', label: '想先用便宜的克難起步', score: 4, risk: 'warn',
                    note: '便宜爬箱常通風不良、溫控品質不穩，反而增加守宮健康風險。基本配備不需頂規，但建議選有口碑的入門款。' },
                { id: 'b1d', label: '不想花什麼錢在這上面', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'b2c', label: '需要時可能要臨時湊', score: 5, risk: 'warn',
                    note: '緊急狀況若延遲就醫，守宮病情急轉直下。建議至少預備一筆可立即動用的應急金，避免錯失最佳治療時機。' },
                { id: 'b2d', label: '目前經濟拮据，沒多餘預算', score: 0, risk: 'critical',
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'b3c', label: '只知道一般犬貓動物醫院', score: 3, risk: 'critical',
                    note: '一般犬貓獸醫多無爬蟲臨床經驗，緊急時可能誤診或無法處置。請於飼養前先找到 1–2 家爬蟲專科醫院的聯絡資訊。' },
                { id: 'b3d', label: '完全不知道要去哪看醫生', score: 0, risk: 'critical',
