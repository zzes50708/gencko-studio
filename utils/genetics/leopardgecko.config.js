...
export const LEOPARD_GECKO_GENES = [
  ...
  { id: 'mandarine', name: '蜜橘', type: CALC_TYPES.BLOOD, category: 'bloodline', baseGeneId: 'tangerine', group: '橘化血系' },
  { id: 'blood', name: '血橘', type: CALC_TYPES.BLOOD, category: 'bloodline', baseGeneId: 'tangerine', group: '橘化血系' },
  { id: 'inferno', name: '地獄', type: CALC_TYPES.BLOOD, category: 'bloodline', baseGeneId: 'tangerine', group: '橘化血系' },
  { id: 'electric', name: '電橘', type: CALC_TYPES.BLOOD, category: 'bloodline', baseGeneId: 'tangerine', group: '橘化血系' },
  { id: 'stonewash', name: '石洗', type: CALC_TYPES.BLOOD, category: 'bloodline', baseGeneId: 'tangerine', group: '橘化血系' },
...
export const LeopardGeckoConfig = {
  ...
  presetMorphs: LEOPARD_GECKO_GENES.filter((gene) => Array.isArray(gene.components) && gene.components.length > 0),
