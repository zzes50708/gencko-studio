...
<template>
  <NuxtLink :to="linkTo" class="flip-card card slim-card" style="text-decoration:none; color:inherit;">
    <div class="flip-inner">
      ...
      <div class="flip-face flip-front">
        ...
        <div style="position:relative;">
          ...
          <div v-if="isWishlisted || isCompared" class="flip-front-indicators dt-only" aria-hidden="true">
          ...
          <div
            ...
            style="display:flex;align-items:center;justify-content:center;color:#333;font-size:1rem;background:#000;"
          >無圖片</div>
      ...
      <div class="flip-face flip-back" aria-hidden="true">
        <div class="flip-back-inner">
          ...
          <div class="flip-back-row"><span class="k">性別</span><span class="v">{{ genderText }}</span></div>
          <div class="flip-back-row"><span class="k">生日</span><span class="v">{{ birthdayText }}</span></div>
          <div class="flip-back-row"><span class="k">價格</span><span class="v">{{ priceText }}</span></div>
