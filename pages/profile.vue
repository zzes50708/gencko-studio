        ...
        <div class="user-card" :class="{'guest-card': !store.currentUser}">
            <div class="user-info">
                <template v-if="store.currentUser">
                    <img v-if="store.currentUser.picture" :src="store.currentUser.picture" alt="Avatar" class="user-avatar" loading="lazy" decoding="async" >
                ...
                <div v-if="!store.currentUser" class="login-prompt-box">
                    ...
                    <div class="login-buttons">
                        <button @click="store.loginWithLine" class="btn-login line">
                            <img src="https://cdn.jsdelivr.net/gh/zzes50708/gencko-assets@main/img/line.png" alt="LINE" style="width: 24px; height: 24px; object-fit: contain;" loading="lazy" decoding="async" >
                            使用 LINE 帳號登入
                        </button>
