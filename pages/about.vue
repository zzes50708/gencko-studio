...
const aboutPageLd = {
  ...
  description:
    'Gencko Breeding Studio（Gencko Studio / 捷客工作室）是台灣專業豹紋守宮繁育工作室。創立於 2025 年，由 Gino 創辦於三重，提供守宮選購、基因計算、飼養教學與健康評估的一站式服務。',
  inLanguage: 'zh-TW',
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content:
        'Gencko Breeding Studio（Gencko Studio / 捷客工作室）是台灣專業豹紋守宮繁育工作室。創立於 2025 年，由 Gino 創辦於三重，提供守宮選購、基因計算機、新手飼養教學、健康評估、特寵醫院查詢與線上競標的一站式服務。'
    },
    {
      name: 'keywords',
      content:
        'Gencko, Gencko Breeding Studio, 捷客工作室, 豹紋守宮工作室, 台灣守宮繁育, 三重守宮, Gino'
    },
    // Open Graph
    {
      property: 'og:title',
      content: '關於我們｜Gencko Breeding Studio 台灣豹紋守宮專業繁育工作室'
    },
    {
      property: 'og:description',
      content: '台灣專業豹紋守宮繁育工作室，創立於 2025 年。從基因到飼養的一站式服務。'
    },
  ...
  script: [
    { type: 'application/ld+json', innerHTML: JSON.stringify(aboutPageLd) },
    { type: 'application/ld+json', innerHTML: JSON.stringify(aboutBreadcrumbLd) }
  ],
