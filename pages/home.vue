...
<template>
  <div class="home-page-wrapper">
      ...
      <div class="hero-content hero-content-inner">
        ...
        >
          <div class="hero-bento">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61579393505049&locale=zh_TW"
              target="_blank"
              class="bento-btn"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://myship.7-11.com.tw/general/detail/GM2509175195515"
              target="_blank"
              class="bento-btn"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://line.me/ti/g2/x4QpkWPJTXYr87U_jHyxSrBLTeVYMdwwlPF9qg"
              target="_blank"
              class="bento-btn bento-btn--wide"
              rel="noopener noreferrer"
            >
              🔥 點擊加入社群享優惠
            </a>
    ...
    <section class="mobile-only home-scenario-bento-wrap" aria-label="快速導覽（手機）">
      <div class="scenario-bento-box" aria-hidden="false">
        <nav class="hero-bento hero-bento--scenario" aria-label="快速導覽">
          <button type="button" class="bento-btn bento-btn--scenario" @click="goToStarterGuide">
            🌱 新手入門
          </button>
          <NuxtLink
            to="/auction"
            class="bento-btn bento-btn--scenario"
    ...
    <nav class="home-scenario-grid" aria-label="快速導覽">
      <div class="scenario-card" @click="goToStarterGuide" role="button" tabindex="0">
      ...
      <NuxtLink
        to="/auction"
        class="scenario-card"
        style="text-decoration: none; display: block; color: inherit; position: relative"
      >
          ...
          >
            <template #default="{ groupIndex }">
              <div
                ...
                :style="{
                  '--hot-i': String(Number(idx) + Number(groupIndex) * (hotList.length + 1))
                }"
              >
                ...
                <div class="hot-card-item">
                  <NuxtLink :to="i?.ID ? `/product/${i.ID}` : '/shop'" class="hot-card-link">
                    <div class="hot-card-layer">
                      ...
                      <div
                        v-else-if="
                          i.Status === 'Auction' && auctionList.some((a) => a.animal_id === i.ID)
                        "
